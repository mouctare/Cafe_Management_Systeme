...
@Slf4j
@Service
public class BillRestImpl implements BillService {
  ...
  private BillRepository billRepository;
        ...
        try {
             ...
             if(validateRequestMap(requestMap)){
               ...
               String data = "Name: "+requestMap.get("name") + "\n" + "ContactNumber: " + requestMap.get("contactNumber") +
                       "\n" +"Email: "+requestMap.get("email")+"\n" + "Payment Methode: " + requestMap.get("paymentMethod");
                 ...
                 Paragraph footer = new Paragraph("Total : "+requestMap.get("totalAmount")+"\n" +"Merci pour votre visite à trés vite !", getFont("Data"));
                 document.add(footer);
                 document.close();
    ...
    private void addTableHeader(PdfPTable table) {
        ...
        Stream.of("Name", "Category", "Quantity", "Price", "Sub Total")
                .forEach(colmnTitle ->{
                    ...
                    header.setPhrase(new Phrase(colmnTitle));
    ...
    private void insertBill(Map<String, Object> requestMap) {
        try {
            ...
            bill.setTotal((Double) requestMap.get("totalAmount"));
    ...
    private byte[] getBArray(String filePath) throws IOException {
